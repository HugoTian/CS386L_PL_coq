...
Proof.
  ...
  unfold not; intros [H1 | H2]. inversion H1. inversion H2; subst. inversion H0.
Qed.      
(** [] *)
...
Proof with auto.
  ...
  - inversion IHHT.
      + left. unfold value; right. inversion H.
          * inversion H0; subst. inversion HT. inversion HT.
...
(** Suppose, instead, that we add this new rule to the [step] relation:
   ...
   this rule?  For each one that does, give a counter-example.
     ...
     - Determinism of [step]
             False
             Counter example :  (tif true t2 t3) can step to
