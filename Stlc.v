...
* generalize dependent t'. induction t. intros t'.
  (* variable *)
  + intros. inversion H; subst. unfold subst.
  (* x = y *) 
     - destruct (beq_id i i) eqn: Hi. reflexivity. exfalso. apply beq_id_false_iff in Hi.
  ...
  +  intros. inversion H; subst; clear H.
     ...
     apply IHt1 in H2. apply IHt2 in H4. rewrite H2. rewrite H4. reflexivity.
  + intros. inversion H; subst.
      ...
      - unfold subst. destruct (beq_id x i) eqn: Hi.
        ...
        apply H4. reflexivity. fold subst. apply IHt in H5. rewrite H5. reflexivity.
  + intros. unfold subst. inversion H.  reflexivity.                    
  +  intros. unfold subst. inversion H. reflexivity.
  +  intros. inversion H; subst. replace  ([x := s]tif t1 t2 t3) with
...
(** $Date: 2016-05-26 16:51:14 -0500 (Thu, 26 May 2016) $ *)
