...
Qed.
*)
Theorem add_single_elem : forall (n : nat) (s : bag),
...
Theorem rev_help : forall (n : nat) (l : natlist), rev( l ++ [n]) = n :: rev l.
Proof. intros n l. induction l as [ | z l' IHl'].
  -simpl. reflexivity.
  -simpl. rewrite -> IHl'. reflexivity.
Qed.
...
Proof.
  intros l. induction l as [ | n l' IHl'].
  -simpl. reflexivity.
  -simpl. rewrite -> rev_help. rewrite->IHl'. reflexivity.
Qed.
...
Fixpoint beq_natlist (l1 l2 : natlist) : bool :=
  match l1 with 
    ...
    | h :: t1 => match l2 with 
              | nil => false
              | z2 :: l2' => if beq_nat h z2 then beq_natlist t1 l2'
                              else false
                 end
   end.
...
Proof. intros l1 l2 H. rewrite <- rev_involutive . rewrite <- H. rewrite -> rev_involutive.
  reflexivity. Qed.  
(** [] *)
...
Proof.
  intros x.  destruct x as [ x']. simpl.  rewrite <- beq_nat_refl. reflexivity. Qed.
(** [] *)
...
(* FILL IN HERE *)
  None, the type baz only has 2 constructors.
*)
(** [] *)
